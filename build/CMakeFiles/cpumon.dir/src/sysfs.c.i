# 0 "/home/jscha/dvp/cpumon/src/sysfs.c"
...
# 0 "<command-line>" 2
# 1 "/home/jscha/dvp/cpumon/src/sysfs.c"
...
# 5 "/home/jscha/dvp/cpumon/src/sysfs.c" 2
...
# 6 "/home/jscha/dvp/cpumon/src/sysfs.c" 2
...
# 7 "/home/jscha/dvp/cpumon/src/sysfs.c" 2
...
# 29 "/home/jscha/dvp/cpumon/src/sysfs.c"
        ...
        if(!strncmp(line, "model name", 10)) {
            sscanf(line,"%*s%*s%*s%*s%*s%*s%*s%s", model);
            break;
...
# 206 "/home/jscha/dvp/cpumon/src/sysfs.c"
    ...
    for (int core = 0; core < (core_count); core++){
        if (total_jiffies_after[core] - total_jiffies_before[core] != 0) {
        load[core] = (float)(100 * (work_jiffies_after[core] - work_jiffies_before[core])) / (float)(total_jiffies_after[core] - total_jiffies_before[core]);
            ...
            load[core] = (100 * (work_jiffies_after[core] - work_jiffies_before[core])) / 1;
        }
        total += load[core];
    }
